...
# Next Steps for ndx-ibl-bwm Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-ibl-bwm directory: `cd ndx-ibl-bwm`
...
`spec/ndx-ibl-bwm.namespace.yaml` and
`spec/ndx-ibl-bwm.extensions.yaml` files.

6. Define API classes for your new extension data types.

    - As a starting point, `src/pynwb/ndx_ibl_bwm/__init__.py` includes an
...
`src/pynwb/ndx_ibl_bwm/tests` or `src/matnwb/tests`.
...
`src/pynwb/ndx_ibl_bwm/widgets` so that the visualizations can be displayed with
[nwbwidgets](https://github.com/NeurodataWithoutBorders/nwbwidgets).
You will also need to update the `vis_spec` dictionary in 
`src/pynwb/ndx_ibl_bwm/widgets/__init__.py` so that
...
2. Start a git repository for your extension directory ndx-ibl-bwm
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/grg2rsr/ndx-ibl-bwm/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).
...
9. Publish your updated extension on [PyPI](https://pypi.org/).
    ...
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-ibl-bwm/0.1.0
...
`staged-extensions/ndx-ibl-bwm`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-ibl-bwm
    ```

13. Edit `staged-extensions/ndx-ibl-bwm/ndx-meta.yaml`
with information on where to find your NWB extension.
    ...
    - You may copy and modify the following YAML that was auto-generated:
      ...
      name: ndx-ibl-bwm
      version: 0.1.0
      src: https://github.com/grg2rsr/ndx-ibl-bwm
      pip: https://pypi.org/project/ndx-ibl-bwm/
      license: BSD-3-Clause
      maintainers: 
        - grg2rsr
      ```

14. Edit `staged-extensions/ndx-ibl-bwm/README.md`
to add information about your extension. You may copy it from
`ndx-ibl-bwm/README.md`.

  ```bash
  cp ndx-ibl-bwm/README.md staged-extensions/ndx-ibl-bwm/README.md
  ```
...
git add ndx-ibl-bwm
git commit -m "Add new catalog entry for ndx-ibl-bwm" .
git push
```
...
ndx-ibl-bwm-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-ibl-bwm GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-ibl-bwm-record repository on GitHub.
